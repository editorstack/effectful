...
import 'package:effectful_utils/src/comparator.dart';

Comparator<E> _getComparator<E>(
  int order,
  Comparable<Object?> Function(E element) selector, {
  Comparator<E>? parent,
}) {
...
class SortedList<E> extends _DelegatingList<E> {
  ...
  Never _throwUnsupportedMutation() {
    throw UnsupportedError('SortedList is immutable.');
  }
  ...
  /// [selector] function.
  SortedList<E> thenBy(Comparable<Object?> Function(E element) selector) {
  ...
  @override
  void operator []=(int index, E value) => _throwUnsupportedMutation();

  @override
  void add(E value) => _throwUnsupportedMutation();

  @override
  void addAll(Iterable<E> iterable) => _throwUnsupportedMutation();

  @override
  void clear() => _throwUnsupportedMutation();

  @override
  void fillRange(int start, int end, [E? fillValue]) => _throwUnsupportedMutation();

  @override
  set first(E element) => _throwUnsupportedMutation();

  @override
  void insert(int index, E element) => _throwUnsupportedMutation();

  @override
  void insertAll(int index, Iterable<E> iterable) => _throwUnsupportedMutation();

  @override
  set last(E element) => _throwUnsupportedMutation();

  @override
  set length(int newLength) => _throwUnsupportedMutation();

  @override
  bool remove(Object? value) => _throwUnsupportedMutation();

  @override
  E removeAt(int index) => _throwUnsupportedMutation();

  @override
  E removeLast() => _throwUnsupportedMutation();

  @override
  void removeRange(int start, int end) => _throwUnsupportedMutation();

  @override
  void removeWhere(bool Function(E element) test) => _throwUnsupportedMutation();

  @override
  void replaceRange(int start, int end, Iterable<E> iterable) => _throwUnsupportedMutation();

  @override
  void retainWhere(bool Function(E element) test) => _throwUnsupportedMutation();

  @override
  void setAll(int index, Iterable<E> iterable) => _throwUnsupportedMutation();
  ...
  void setRange(
    ...
    int skipCount = 0,
      ...
      _throwUnsupportedMutation();

  @override
  void shuffle([Random? random]) => _throwUnsupportedMutation();

  @override
  void sort([int Function(E a, E b)? compare]) => _throwUnsupportedMutation();
