...
extension Function1InvokeExtensions<A, R> on Function1<A, R> {
  /// Invokes this function and returns its return value.
...
extension Function2CurryExtension<A, B, R> on Function2<A, B, R> {
  Function1<A, Function1<B, R>> curry() => (A first) => (B second) => this(first, second);
}
...
extension Function3PartialExtension<R, A, B, C> on Function3<A, B, C, R> {
  Function2<B, C, R> partial(A first) => (B second, C third) => this(first, second, third);
}

extension Function3Partial2Extension<R, A, B, C> on Function3<A, B, C, R> {
  Function1<C, R> partial2(A first, B second) => (C third) => this(first, second, third);
}

extension Function3Partial3Extension<R, A, B, C> on Function3<A, B, C, R> {
  Function0<R> partial3(A first, B second, C third) => () => this(first, second, third);
}

extension Function3UncurryExtension<A, B, C, R> on Function1<A, Function1<B, Function1<C, R>>> {
  Function3<A, B, C, R> uncurry() => (A first, B second, C third) => this(first)(second)(third);
}

extension Function4InvokeExtension<R, A, B, C, D> on Function4<A, B, C, D, R> {
  /// Invokes this function and returns its return value.
  R invoke(A first, B second, C third, D fourth) => this(first, second, third, fourth);
}
...
extension Function4CurryExtension<R, A, B, C, D> on Function4<A, B, C, D, R> {
  Function1<A, Function1<B, Function1<C, Function1<D, R>>>> curry() =>
      (A first) => (B second) => (C third) => (D fourth) => this(first, second, third, fourth);
}
...
extension Function4Partial2Extension<R, A, B, C, D> on Function4<A, B, C, D, R> {
  Function2<C, D, R> partial2(A first, B second) =>
      (C third, D fourth) => this(first, second, third, fourth);
}

extension Function4Partial3Extension<R, A, B, C, D> on Function4<A, B, C, D, R> {
  Function1<D, R> partial3(A first, B second, C third) =>
      (D fourth) => this(first, second, third, fourth);
}

extension Function4Partial4Extension<R, A, B, C, D> on Function4<A, B, C, D, R> {
